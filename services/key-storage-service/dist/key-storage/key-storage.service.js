...
exports.KeyStorageService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const libs_1 = require("@shared/libs");
let KeyStorageService = class KeyStorageService {
    walletsRepository;
    constructor(walletsRepository) {
        this.walletsRepository = walletsRepository;
    }
    async storeEncryptedKey(walletId, encryptedPrivateKey) {
        await this.walletsRepository.update(walletId, { encryptedPrivateKey });
    }
    async getEncryptedKey(walletId) {
...
exports.KeyStorageService = KeyStorageService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(libs_1.Wallet)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], KeyStorageService);
//# sourceMappingURL=key-storage.service.js.map